  ...
  <tr>
    <td align="center" width="33%">
      ...
      <a href="https://asciinema.org/a/ha0577C30eV22PwJ" target="_blank">
        <img src="https://asciinema.org/img/play-button.png" width="100" alt="Tenant Provisioning"/>
      </a>
    </td>
    <td align="center" width="33%">
      <b>2. Tenant Validation</b><br/>
      <a href="https://asciinema.org/a/KbTlRvky9mGqSoo9" target="_blank">
        <img src="https://asciinema.org/img/play-button.png" width="100" alt="Tenant Validation"/>
      </a>
    </td>
    <td align="center" width="33%">
      <b>3. Full Platform Showcase</b><br/>
      <a href="https://asciinema.org/a/jr3CRkDl1eXs4pLr" target="_blank">
        <img src="https://asciinema.org/img/play-button.png" width="100" alt="Platform Showcase"/>
      </a>
    </td>
  </tr>
</table>
...
If the terminal recording scrolls too quickly, you can expand this section to read the exact text output generated by running `./cli/showcase-platform` (validating KubeVirt nodes/VMs, HAMi GPU slicing, Crossplane v2, CAPI, decentralized regional ArgoCD, network isolation, and TLS routing):
