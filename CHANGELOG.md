...
**Workflow:** the author builds/codes in the lab; posts are written from that work.
Drafts live in [`/post`](./post) (raw, EN/ES, copy-paste). Published pages live in [`/docs`](./docs) — the
GitHub Pages blog (https://villadalmine.github.io/vcluster-idp/). A draft is **not** on the blog until it has
a `docs/` page + a row in `docs/index.md`.
...
- **02** — vCluster on an existing cluster · video `OR3lKd81K3zGNI4i`
